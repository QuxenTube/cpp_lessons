                ...
                if (checker) {
                    for (int i = 0; i < count; ++i) {
                        if (books[i].id == idInput && count != 0) {
                            checker = true; // ID already exists
                            std::cout << "Error: ID already exists. Exiting." << std::endl;
                            break;
                        }
                        else {
                            checker = false; // ID does not exist
